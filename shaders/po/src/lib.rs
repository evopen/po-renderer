...
unsafe impl spirv_std::vector::Vector<f32, 1> for Rf32 {}
...
pub fn main(
    ...
    unsafe {
        ...
        depth_image.write(xy, Rf32(payload.x));
    }
}
...
pub fn closest_hit(
    ...
    world_normal = utils::facefoward(&world_normal, &world_ray_direction);
